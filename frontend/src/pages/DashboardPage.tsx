      ...
      <main className="max-w-7xl mx-auto px-6 py-14">
        ...
        <section className="mt-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <SystemCard
              title="Settings"
              description="Update Azure credentials, rotate your DevOps PAT, or reset Vantage to factory settings."
              accentColor="#f87171"
              accentBorder="rgba(239,68,68,0.25)"
              accentBackground="rgba(239,68,68,0.08)"
              accentIconBorder="rgba(239,68,68,0.2)"
